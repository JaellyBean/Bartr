...
export default function OnboardingScreen({ navigation }) {
  ...
  const handleSave = async () => {
    if (!bio.trim() || skillsList.length === 0 || !fullName.trim()) {
      Alert.alert('Almost there', 'Please add your full name, a short bio, and at least one skill.');
      return;
    }
  ...
  return (
    ...
    >
      <LinearGradient colors={['rgba(16, 185, 129, 0.15)', '#030712']} style={StyleSheet.absoluteFillObject} />
      <View style={styles.content}>
        <BlurView intensity={20} tint="dark" style={styles.card}>
          <View style={styles.header}>
            ...
            <Text style={styles.subtitle}>Let the community know what you offer</Text>
          </View>
          ...
          <View style={styles.form}>
            ...
            <View style={styles.skillsInputContainer}>
              ...
              <TextInput
                style={[styles.input, { marginBottom: 0, borderWidth: 0, paddingHorizontal: 0, backgroundColor: 'transparent' }]}
