...
export default function SignUp() {
  ...
  if (isSuccess) {
    return (
      <div className="min-h-screen bg-[#030712] text-gray-50 flex flex-col items-center justify-center p-6 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-indigo-900/20 via-[#030712] to-[#030712]">
        <div className="w-full max-w-md p-8 bg-gray-900/40 border border-gray-800/60 rounded-3xl backdrop-blur-xl text-center shadow-2xl shadow-emerald-500/10">
          ...
          <p className="text-gray-400 mb-8">We've sent a magic link to {email}. Click the link to complete your account setup and download the app.</p>
  ...
  return (
    <div className="min-h-screen bg-[#030712] text-gray-50 flex flex-col items-center justify-center p-6 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-indigo-900/20 via-[#030712] to-[#030712]">
      ...
      <div className="w-full max-w-md p-8 sm:p-10 bg-gray-900/40 border border-gray-800/60 rounded-3xl backdrop-blur-xl shadow-2xl shadow-indigo-500/10">
        <div className="flex flex-col items-center mb-8">
          ...
          <h2 className="text-2xl font-bold">Join Bartr</h2>
          <p className="text-sm text-gray-400 mt-2">Start trading skills with your community</p>
        </div>
